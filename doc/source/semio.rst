...
Les trois autres cartes **par département**, **par commune focus sur Paris** et **par carreau focus sur Paris** illustrent le *Modifiable Areal Unit Problem*. La répartition de la population change drastiquement en fonction de la taille des unités spatiales considérés. A l'échelle des départements, la variabilité communale est masquée. Il est en de même à l'échelle des communes qui masque totalement la répartition fine de la population contenue dans les carreaux de 200 m (Insee Filosofi 2015).
